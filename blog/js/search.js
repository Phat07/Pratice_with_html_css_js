...
let value=queryString.get('keyword');


// API.get(`articles/search?q=${value}&limit=6&page=${1}`).then((res)=>{
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      <div class="post-header">
                        <!-- /.post-category -->
                        <h2 class="post-title h3 mt-1 mb-3"><a class="link-dark" href="./blog-post.html">${e.title}</a></h2>
                      </div>
                      <!-- /.post-header -->
                    ...
                    <div class="card-footer">
                      <ul class="post-meta d-flex mb-0">
                        <li class="post-date"><i class="uil uil-calendar-alt"></i><span>${dayjs(e.publish_date).fromNow()}</span></li>
...
function fetchArticles(page = 1) {  
  API.get(`articles/search?q=${value}&limit=6&page=${page}`).then((res) => {
    console.log(res.data);
    const data = res.data.data;
    rederSearch(data)
